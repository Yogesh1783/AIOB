                        ...
                        <div class="page-header">
                            <div class="page-header-1">
                             ...
                             <div class="page-header-1">
                                 ...
                                 <a href="<?php echo base_url('index.php/Admin/addGoldLoanOffer')?>"><button class="btn ripple btn-main-primary" style="background-color: blue;">Add Gold Loan Offer</button></a>
                            </div>
                        </div>
                         <div class="page-header">
                            <div class="page-header-1">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table style="wIDth:100%" ID="example3" class="table table-striped table-bordered text-nowrap" >
                                                ...
                                                <tbody>
                                                    <?php $index=1; 
                                                    foreach($goldloanlists as $goldloanlist){?>
                                                    <tr>
                                                        <td><?php echo $index?></td>
                                                        <td><?php echo $goldloanlist->GoldLoanOffer?></td>
