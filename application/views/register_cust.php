...
<!-- Mirrored from www.spruko.com/demo/dashpro/Dashpro/HTML-LTR/Horizontal-light/signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Jan 2022 05:23:49 GMT -->
<head>
        ...
        <!-- Title -->
        <title>AIOBD - All In One Bank Details</title>
    ...
    <!-- Switcher -->
        ...
        <div class="page main-signin-wrapper">
            ...
            <!-- Row -->
            <div class="row signpages  justify-content-left text-center sign-2">
                <div class="col-md-10 col-xl-6">
                    <div class="sign1">
                        <div class="card">
                            <div class="">

                                <div class="card-body mt-2 mb-2 p-6">

                                    <img src="../../assets/img/brand/5.png" class="header-brand-img text-left mb-5 desktop-logo" alt="logo">
                                    <img src="../../assets/img/brand/5.png" class="header-brand-img desktop-logo text-left mb-5 theme-logo" alt="logo">

                                    <div class="clearfix"></div>
                                    <h5 class="text-left mb-3"> Login</h5>
                                        

                                    <div class="page-header-1">
                                        <div class="mb-3">
                            <button class="btn ripple btn-main-primary" style="background-color: blue;"> <a style="color:white" href="<?php echo base_url('#')?>">Client</a></button>
                            <button class="btn ripple btn-main-primary" style="background-color: blue;"> <a style="color:white" href="<?php echo base_url('#')?>">Advocate</a></button>
                            <button class="btn ripple btn-main-primary" style="background-color: blue;"> <a style="color:white" href="<?php echo base_url('index.php/home/home')?>">Home</a></button>
                            </div>
                        </div>
                                    <form id="loginForm" action="<?php echo base_url('index.php/Home/insertCustomer'); ?>" method="POST" >

                                        <div class="form-group text-left">
                                            <label class="">Mobile Number</label>
                                            <input class="form-control rounded-11" placeholder="Mobile Number" name="custMobile" type="text">
                                             
                                        </div>

                                        <div class="form-group text-left">
                                            <label class="">Email Address</label>
                                            <input class="form-control rounded-11" placeholder="Users email" name="custEmail" type="text">
                                             
                                        </div>
                                        <div class="form-group text-left">
                                            <label class="">Password</label>
                                            <input class="form-control rounded-11" placeholder="password" name="custPassword" type="password">
                     ...
                     <input type="submit" name="insert" value="Register" class="btn btn-primary rounded-11 btn-block" />  
                    <?php  
