                        ...
                        <div class="page-header">
                            <div class="page-header-1">
                             ...
                             <div class="page-header-1">
                                 ...
                                 <a href="<?php echo base_url('index.php/Admin/addHomeLoanOffer')?>"><button class="btn ripple btn-main-primary" style="background-color: blue;">Add Home Loan Offer</button></a>
                            </div>
                        </div>
                         <div class="page-header">
                            <div class="page-header-1">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table style="wIDth:100%" ID="example3" class="table table-striped table-bordered text-nowrap" >
                                                ...
                                                <tbody>
                                                    <?php $index=1; 
                                                    foreach($homeloanlists as $homeloanlist){?>
                                                    <tr>
                                                        <td><?php echo $index?></td>
                                                        <td><?php echo $homeloanlist->HomeLoanOffer?></td>
