...
<head>
    ...
    <body style="background-image: url(../../assets/img/brand/Bank_logo.jpg); background-repeat: no-repeat; background-size: 100%;" class="horizontalmenu">
            ...
            <div class="row signpages  justify-content-left text-center sign-2">
                <div class="col-md-10 col-xl-6">
                    <div class="sign1">
                        <div class="card">
                            <div class="">
                                ...
                                <div class="card-body mt-2 mb-2 p-6">
                                    ...
                                    <img src="../../assets/img/brand/iconpivon4.PNG" class="header-brand-img text-left mb-5 desktop-logo" alt="logo">
                                    <img src="../../assets/img/brand/iconpivon4.PNG" class="header-brand-img desktop-logo text-left mb-5 theme-logo" alt="logo">
                            ...
                            <button class="btn ripple btn-main-primary" style="background-color: blue;"> <a style="color:white" href="<?php echo base_url('index.php/home/home')?>">Home</a></button>
                                    ...
                                    <form id="loginForm" action="<?php echo base_url('index.php/Admin/verifylogin'); ?>" method="POST" >
                     ...
                     <input type="submit" name="insert" value="Login" class="btn btn-primary rounded-11 btn-block" />  
                    <?php  
